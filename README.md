...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.squel.ch)**
...
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.squel.ch)](https://homelab.squel.ch)
...
- [Try it out locally](https://homelab.squel.ch/installation/sandbox) without any hardware (just 4 commands!)
- [Deploy on real hardware](https://homelab.squel.ch/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.squel.ch/reference/roadmap) and [open issues](https://github.com/khuedoan/homelab/issues) for a list of proposed features and known issues.

## Contributing

Any contributions you make are greatly appreciated.

Please see [contributing guide](https://homelab.squel.ch/reference/contributing) for more information.
...
See [license page](https://homelab.squel.ch/reference/license) or `LICENSE.md` file for more information.
